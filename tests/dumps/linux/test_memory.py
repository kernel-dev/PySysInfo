...
class TestLinuxMemory:
    ...
    def _create_dmi_blob(self, 
        ...
        if extended_size is not None:
            ...
            data[0x1C:0x20] = extended_size.to_bytes(4, 'little') # Note: Code reverses hex, so it expects LE in memory?
    ...
    def test_fetch_memory_info_non_ecc(self, monkeypatch):
        ...
        monkeypatch.setattr(subprocess, "check_output", lambda x: blob)
    ...
    def test_fetch_memory_info_parsing_error(self, monkeypatch):
        ...
        monkeypatch.setattr(subprocess, "check_output", lambda x: b'DIMM')
    ...
    def test_fetch_memory_info_kilobyte_capacity(self, monkeypatch):
        ...
        monkeypatch.setattr(subprocess, "check_output", lambda x: bytes(data))
